    ...
    return {
      ...
      routes: copy.routes.map((route) => {
        ...
        return {
          ...
          fare: route.fare,
          legs: route.legs.map((leg: { start_location: { lat: number | google.maps.LatLng | google.maps.LatLngLiteral; lng: number | boolean | null | undefined; }; end_location: { lat: number | google.maps.LatLng | google.maps.LatLngLiteral; lng: number | boolean | null | undefined; }; steps: any[]; }) => ({
          ...leg,
